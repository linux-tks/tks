...
pub fn register_org_freedesktop_secret_service<T>(cr: &mut crossroads::Crossroads) -> crossroads::IfaceToken<T>
where T: OrgFreedesktopSecretService + Send + 'static
{
    cr.register("org.freedesktop.Secret.Service", |b| {
        ...
        b.method("SearchItems", ("attributes",), ("unlocked","locked",), |_, t: &mut T, (attributes,)| {
            t.search_items(attributes,)
        })
            .annotate("org.qtproject.QtDBus.QtTypeName.In0", "StrStrMap");
        b.method("Unlock", ("objects",), ("unlocked","prompt",), |_, t: &mut T, (objects,)| {
            t.unlock(objects,)
        });
        ...
        b.method("ReadAlias", ("name",), ("collection",), |_, t: &mut T, (name,)| {
            t.read_alias(name,)
                .map(|x| (x,))
        });
        b.method("SetAlias", ("name","collection",), (), |_, t: &mut T, (name,collection,)| {
            t.set_alias(name,collection,)
        });
