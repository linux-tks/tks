...
pub trait OrgFreedesktopSecretService {
    ...
    ) -> nonblock::MethodReply<(Vec<dbus::Path<'static>>, Vec<dbus::Path<'static>>)>;
    fn unlock(
        &self,
        objects: Vec<dbus::Path>,
    ) -> nonblock::MethodReply<(Vec<dbus::Path<'static>>, dbus::Path<'static>)>;
    fn lock(
        &self,
        objects: Vec<dbus::Path>,
    ) -> nonblock::MethodReply<(Vec<dbus::Path<'static>>, dbus::Path<'static>)>;
...
impl<'a, T: nonblock::NonblockReply, C: ::std::ops::Deref<Target = T>> OrgFreedesktopSecretService
